...
void    sm4_key_schedule_enc (
    ...
    uint32_t K0 = bswap32(mkp[0]) ^ FK[0];
    uint32_t K1 = bswap32(mkp[1]) ^ FK[1];
    uint32_t K2 = bswap32(mkp[2]) ^ FK[2];
    uint32_t K3 = bswap32(mkp[3]) ^ FK[3];
...
void    sm4_block_enc_dec (
    ...
    uint32_t   X0  = bswap32(inp[0]);
    uint32_t   X1  = bswap32(inp[1]);
    uint32_t   X2  = bswap32(inp[2]);
    uint32_t   X3  = bswap32(inp[3]);
